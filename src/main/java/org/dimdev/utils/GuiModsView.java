...
public class GuiModsView extends GuiScreen {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		String versions = I18n.format("riftmodlist.versions", (mod.version != null ? mod.version : "Unidentified"));
		...
		if (mod.url != null) {
			String url = I18n.format("riftmodlist.url", (mod.url != null ? mod.url : "Unidentified"));
		...
		String id = I18n.format("riftmodlist.id", mod.id);
